                                                ...
                                                <form method="post" id="ForceTochangePwd" action="force_reset_password">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <input class="form-control required" required type="password" name="old_password" maxlength="28"><br>
                                                            @error('msgOldPass')
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <input class="form-control required" type="password" name="new_password" maxlength="28"><br>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <label>Confirm Password<span class="text-danger">*</span></label>
                                                            <input class="form-control required" type="password" name="confirm_password" maxlength="28"><br>
