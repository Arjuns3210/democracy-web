            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-6 col-sm-7">
                                    <h5 class="pt-2">Copy Contest : {!! toolTipInfo($data['name'],$data['contest_code'])!!}</h5>
                                </div>
                        ...
                        <!-- <hr class="mb-0"> -->
                    	<div class="card-body">
                            <form autocomplete="off" id="copyContestData" method="post" action="contest/save">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label>Name<span class="text-danger">*</span></label>
                                        <input class="form-control required" type="text" id="name"  name="name" maxlength="52" value="{{$data['name']}}"><br/>
                                    </div>
                                    <div class="col-sm-6">
                                        <label>Sub Title<span class="text-danger">*</span></label>
                                        <input class="form-control required" type="text" id="sub_title"  name="sub_title" maxlength="200" value="{{$data['sub_title']}}"><br/>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row mb-2">
                                    <div class="col-sm-12">
                                        <div class="pull-right">
                                            <button type="button" class="btn btn-success" onclick="submitForm('copyContestData','post')">Submit</button>
