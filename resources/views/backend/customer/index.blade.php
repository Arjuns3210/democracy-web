                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2" id="listing-filter-data" style="display: none;">
                                            ...
                                            <div class="col-md-4">
                                                <label>Phone</label>
                                                <input class="form-control mb-3 numeric-input" type="text" id="search_phone" maxlength="10" name="search_phone">
                                            </div>
                                            <div class="col-md-4">
                                            <label>Status</label>
                                            <select class="form-control mb-3 select2 " type="text" id="search_status" name="search_status" style="width: 100%">
