                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane fade mt-2 show active" role="tabpanel">
                                    <div class="row">
                                        <div class="col-12">
                                            <form method="post" autocomplete="off" id="changePwdForm" action="customer/changePassword?id={{$customer['id']}}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <label>New Password<span class="text-danger">*</span></label>
                                                        <input class="form-control required" maxlength="28" type="password" name="new_password">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label>Confirm Password<span class="text-danger">*</span></label>
                                                        <input class="form-control required" maxlength="28" type="password" name="confirm_password" >
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row">
