                                        ...
                                        <div class="row m-0">
                                            <div class="col-md-12 px-4 py-3" style="width:400px">
                                                <form method="POST" action="{{ route('password.update') }}">
                                                    ...
                                                    <input type="password" class="form-control mb-2" placeholder="Password" name="password" maxlength="28"><br>
                                                    <input type="password" class="form-control mb-2" placeholder="Confirm Password" name="password_confirmation" maxlength="28">
                                                    <br>
