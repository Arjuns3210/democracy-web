                            ...
                            <form id="saveNotification" method="post" action="notification/save">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-6 text-center my-2">
                                        <p class="font-weight-bold">Notification Image<span class="text-danger">*</span></p>
                                        ...
                                        <div class="shadow bg-white rounded d-inline-block mb-2">
                                            <div class="input-file">
                                                <label class="label-input-file">Choose Files &nbsp;&nbsp;&nbsp;<i class="ft-upload font-medium-1"></i><input type="file" name="image" class="notification-images required" id="notificationImages" accept=".jpg, .jpeg, .png">
                                                </label>
                                            </div>
                                        </div>
                                        <p id="files-area">
