                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mt-3">
                                            ...
                                            <ul class="nav flex-column nav-pills" id="myTab" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="social-links-tab" data-toggle="tab" href="#social-links" role="tab" aria-controls="social-links" aria-selected="false">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <div class="tab-content">
                                                            ...
                                                            <!-- Social Links Tab -->
                                                            <div class="tab-pane active" id="social-links" role="tabpanel" aria-labelledby="social-links-tab">
                                                                <form id="socialLinkForm" method="post" action="updateSettingInfo?param=social">
                                                                @csrf
                                                                    <div class="row">
                                                                        <div class="col-12 form-group">
                                                                            <label for="facebook">Youtube<span class="text-danger">*</span></label>
                                                                            <input id="facebook" type="text" name="yt_link" class="form-control required" placeholder="Add link" value="{{$data['yt_link']}}">
                                                                        </div>
                                                                        <div class="col-12 form-group">
