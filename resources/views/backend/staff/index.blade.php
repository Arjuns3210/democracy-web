                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2" id="listing-filter-data" style="display: none;">
                                            <div class="col-md-4">
                                                <label>Name</label>
                                                <input class="form-control mb-3" type="text" id="search_name" oninput="validateNameInput(this)" name="search_name">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Nick Name</label>
                                                <input class="form-control mb-3" type="text" id="search_nick_name" oninput="validateNameInput(this)" name="search_nick_name">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Email</label>
                                            ...
                                            <div class="col-md-4">
                                                <label>Phone</label>
                                                <input class="form-control mb-3 numeric-input" type="text" id="search_phone" name="search_phone" maxlength="10">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Role</label>
